...
<html lang="en">
  <head>
    ...
    ></script>
    <script src="/resources/static/rh/js/camping.js"></script>
  </head>
  <body>
    <div>
          ...
          <div class="rh-camping-wood-mainBox">
            ...
            <div class="rh-camping-wood-main">
              ...
              <div class="rh-camping-wood-mainPost" id="content1">
                첫 캠핑 시 기본적으로 필요한 장비는 아래와 같아요.
                <br />
                인원수를 고려해 장비를 준비하는 것이 좋아요. <br />
                ○ 텐트 <br />
                ○ 취사 도구(가스버너, 냄비, 프라이팬 등) <br />○ 취사
                재료(밀키트 등) <br />
                ○ 수면용품(침낭, 매트 등) <br />
                ○ 테이블 <br />
                ○ 보냉팩(아이스박스, 보냉가방) <br />
                ○ 휴대용 랜턴 <br />
                ○ 구급약품 <br />
                ○ 계절에 따른 온/냉방 용품(휴대용 선풍기, 등유 난로 등)
                <br />
                이외의 소화기, 구급용품 등은 <br />
                캠핑장 내에 구비되어 있을 확률이 높으나, 캠핑장 방문 전 확인하는
                것이 좋아요.
              </div>
            </div>
            <div class="rh-camping-wood-main">
            ...
            <div class="rh-camping-wood-main">
              ...
              <div class="rh-camping-wood-mainPost" id="content5">
                캠핑존은 크게 파쇄석, 데크, 잔디로 구분돼요. <br />
                ○ 파쇄석: 바닥이 돌로 이루어져 있고, 팩으로 텐트를 설치할 수
                있어요. 데크보다 공간이 넓고 물 고임이 적어요. 하지만 돌로 인해
                바닥이 울퉁불퉁하기 때문에 텐트 피칭 전 돌을 골고루 펴 주는 것이
                좋아요. <br />
                ○ 데크: 바닥이 목재로 이루어져 있고, 데크 크기에 따라 사용할 수
                있는 텐트가 다르기 때문에 꼭 크기를 확인해야 해요. 또한 데크
                전용 팩(오징어팩, 나사팩 등)을 사용해야 해요. 데크 전용 팩은
                캠핑장마다 허용하는 것이 다르기 때문에 사전에 확인해야 해요.
                또한 화재 위험으로 인해 데크 위에서 화로대 사용은 불가해요.
                화로대 사용 시 데크 밖에서 사용해야 해요. <br />
                ○ 잔디: 바닥이 잔디로 이루어져 있어요. 비가 오는 등 날씨가 좋지
            ...
            <div class="rh-camping-wood-main">
              ...
              <div class="rh-camping-wood-mainPost" id="content7">
                초보 캠퍼가 이용하기 좋을 장소를 선정했어요. (세 곳)
              </div>
            </div>
            <div class="rh-camping-wood-main">
              <div id="icon8">
