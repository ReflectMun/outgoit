          ...
          <div class="rh-camping-wood-mainBox">
            ...
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon1">
                <div>
                  ...
                  <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/fire.png" alt="">
                </div>
            ...
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon2">
                <div>
                  ...
                  <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/gass.png" alt=""></div>
            ...
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon3">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/foodBear.png" alt=""></div>
            ...
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon4">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/trash2.png" alt=""></div>
                <%--사진 1로 할지 2로 할지 고민--%>
              ...
              <div class="rh-camping-wood-mainPost" id="content4">
                ...
                <div class="rh-back-set rh-pointer" id="back4">돌아가기 <img width="20%" src="/resources/static/img/icon/card/next.png" alt=""> </div>
              </div>
            </div>
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon5">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/axe2.png" alt=""></div>
            ...
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon6">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/campNG.png" alt=""></div>
            ...
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="camping-icon7">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/weather2.png" alt=""></div>
              ...
              <div class="rh-camping-wood-mainPost" id="camping-content7">
                ...
                <div class="rh-back-set rh-pointer" id="back7">돌아가기 <img width="20%" src="/resources/static/img/icon/card/next.png" alt=""> </div>
              </div>
            </div>
            <div class="rh-camping-wood-main">
              <div class="rh-pointer" id="icon8">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/pain.png" alt=""></div>
              ...
              <div class="rh-camping-wood-mainPost" id="content8">
                ...
                <div class="rh-back-set rh-pointer" id="back8">돌아가기 <img width="20%" src="/resources/static/img/icon/card/next.png" alt=""> </div>
              </div>
            </div>
            <div class="rh-camping-wood-main" id="animal">
              <div class="rh-pointer" id="icon9">
                ...
                <div> <img style="margin: 10% 0%" width="45%" src="/resources/static/img/icon/card/wildanimals.png" alt=""></div>
