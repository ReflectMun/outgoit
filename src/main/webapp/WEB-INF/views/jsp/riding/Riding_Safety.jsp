            ...
            <div class="rh-riding-wood-mainBox">
                ...
                <div class="rh-riding-wood-main">
                    <div class="rh-pointer" id="icon1">
                        ...
                        <div><img style="margin: 10% 0%" width="45%" src="/static/img/icon/card/bikeCross.png" alt="">
                        </div>
                ...
                <div class="rh-riding-wood-main">
                    <div class="rh-pointer" id="icon2">
                        ...
                        <div><img style="margin: 10% 0%" width="45%" src="/static/img/icon/card/cyclist.png"
                                  alt=""></div>
                ...
                <div class="rh-riding-wood-main">
                    <div class="rh-pointer" id="icon3">
                        ...
                        <div><img style="margin: 10% 0%" width="45%" src="/static/img/icon/card/light.png" alt="">
                        </div>
                ...
                <div class="rh-riding-wood-main">
                    <div class="rh-pointer" id="icon5">
                        ...
                        <div><img style="margin: 10% 0%" width="45%" src="/static/img/icon/card/phoneNG1.png"
                                  alt=""></div>
                ...
                <div class="rh-riding-wood-main">
                    <div class="rh-pointer" id="icon6">
                        ...
                        <div><img style="margin: 10% 0%" width="45%" src="/static/img/icon/card/bikeroad2.png"
                                  alt=""></div>
                ...
                <div class="rh-riding-wood-main" id="animal">
                    <div class="rh-pointer" id="icon9">
                        ...
                        <div><img style="margin: 10% 0%" width="45%" src="/static/img/icon/card/wildanimals.png"
                                  alt=""></div>
