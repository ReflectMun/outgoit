...
<html lang="en">
  <head>
    ...
    <title>${trailRouteList} 상세정보</title>

<%--    <link rel="stylesheet" href="/resources/static/css_hj/campinformation.css" />--%>

    <link rel="stylesheet" href="/static/css_hj/camp_information.css" />
...
<%--            <div class="hj-info-name">${trailAreaName}</div>--%>
<%--          </div>--%>
<%--        </div>--%>
<%--      </div>--%>
<%--      <!-- 판 밑에 연결하는 div -->--%>
...
<%--                <div id="hj-no">총 거리 단위(m): ${trailKm}</div>--%>
<%--                <div id="hj-time">상행시간(분): ${trailHour}</div>--%>
<%--                <div id="hj-addr">난이도: ${trailLevel}</div>--%>
<%--              </div>--%>
<%--            </div>--%>
<%--          </div>--%>
<%--        </div>--%>
...
<%--              content: content,--%>
<%--              // rating: ,--%>
<%--              &lt;%&ndash;campingAreaId: ${campingAreaNumber}&ndash;%&gt;--%>
<%--            }--%>
<%--          )--%>
