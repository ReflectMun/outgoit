            ...
            <div class="rh-hiking-wood-mainBox">
                ...
                <div class="rh-hiking-wood-main">
                    <div class="rh-hiking-wood-mainPost">
                        ...
                        <div id="snakeC">
                            &nbsp;살모사를 제외한 대부분의 뱀은 공격성을 드러내지 않기 때문에 먼저 밟거나 하지 않으면 공격하지 않아요. 만약 뱀을 만났을 경우 가만히 제자리에 서서 뱀이
                            다른 곳으로 지나가길 기다리거나, 뱀이 이동하지 않는다면 우회해서 돌아가야 해요.
                            <br> &nbsp;뱀에 물렸다면 상처 부위를 끈이나 고무줄로 묶어 최대한 독이 퍼지지 않게 하고 최대한 빨리 병원에서 치료받아야 해요. 입으로 독을 빨아내는 것과
                            소독을 위해 상처부위를 술로 씻어내는 것은 좋지 않은 대처법이에요.
                        </div>
                        ...
                        <div id="pigC">
                            &nbsp;멧돼지는 평균 50km의 속도를 낼 수 있으며 후각은 좋으나 시력이 좋지 않아요. 따라서 소리치거나 돌을 던지는 행위는 멧돼지를 자극해요. 또한 멧돼지는
                            헤엄칠 수
                        ...
                        <div id="dogC">
                            ...
                            해당 장소에서 벗어날 경우 가방이나 신발 등을 던져 개의 관심을 돌린 후 탈출해요.
                            <br>&nbsp;물렸을 경우, 상처 부위를 비누로 깨끗하게 씻고 바로 병원으로 이동해야 해요. 광견병 감염 여부는 바로 알 수 없기 때문에 일정
                            기간 이후 발열, 구토, 두통, 흥분,
                            물을 두려워하거나 불안해하는 증상을 보이면 즉시 병원으로 가야 해요.
                        </div>
